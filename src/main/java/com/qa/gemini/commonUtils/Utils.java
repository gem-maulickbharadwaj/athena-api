...
public class Utils {
    ...
    public static Response LoginUser(String UrlNameFromConfig, String method, String pay, String step) throws Exception {
        ...
        try {
            ...
            String payload = ProjectSampleJson.getSampleDataString(pay);
            request.setRequestPayload(payload);

            response = ApiInvocation.handleRequest(request);
            if (response.getStatus() == HttpStatus.SC_OK) {
                GlobalVariable.Token = response.getResponseBodyJson().getAsJsonObject().get("data").getAsJsonObject().get("jwttoken").getAsString();
            }
